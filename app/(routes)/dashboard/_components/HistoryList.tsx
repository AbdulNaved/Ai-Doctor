...
//   CheckCircle,
// } from "lucide-react";
// import { generateMedicalReportPDF } from "../medical-agent/utils/pdfGenerator";
// interface Doctor {
//   id: number;
//   name: string;
//   specialist: string;
...
//               <pre className="whitespace-pre-wrap font-sans text-sm leading-relaxed bg-white p-6 rounded-lg shadow-inner">
//                 {selectedReport}
//               </pre>
//             </div>
